...
from app.models.historico_interacoes import HistoricoInteracoes
from app.models.empresa_cliente import EmpresaCliente
from app.schemas.interacao import InteracaoCreate, InteracaoResponse

router = APIRouter(prefix="/interacoes", tags=["Interações"])

@router.post("", response_model=InteracaoResponse)
def criar_interacao(obj_in: InteracaoCreate, db: Session = Depends(get_db)):
